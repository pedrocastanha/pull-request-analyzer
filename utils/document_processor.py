...
class DocumentProcessor:
    ...
    def _extract_text_from_pdf(self, file_path: str) -> str:
        try:
            ...
            raise HTTPException(status_code=400, detail="Erro ao processar arquivo PDF")
    ...
    def _extract_text_from_docx(self, file_path: str) -> str:
        try:
            ...
            raise HTTPException(status_code=400, detail="Erro ao processar arquivo DOCX")
    ...
    def validate_file_type(self, filename: str) -> str:
        ...
        if extension not in ['pdf', 'docx']:
            ...
            raise HTTPException(
                status_code=400,
                detail="Tipo de arquivo não suportado. Apenas PDF e DOCX são aceitos"
            )
        return extension
    ...
    async def extract_text_from_file(self, file: UploadFile) -> str:
        try:
            ...
            logging.error(f"Unexpected error processing document: {e}", exc_info=True)
